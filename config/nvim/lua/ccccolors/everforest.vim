...
function! s:get_palette(background, colors_override) "{{{
...
function! s:syn_gen(path, last_modified, msg) "{{{
  " Generate the `after/syntax` directory.
  let full_content = join(readfile(a:path), "\n") " Get the content of `colors/everforest.vim`
  let syn_conent = []
  let rootpath = s:syn_rootpath(a:path) " Get the path to place the `after/syntax` directory.
  ...
  for content in syn_conent
    ...
    for syn in syn_list
      call s:syn_write(rootpath, syn, content) " Write the content.
    endfor
  endfor
  call s:syn_write(rootpath, 'text', "let g:everforest_last_modified = '" . a:last_modified . "'") " Write the last modified time to `after/syntax/text/everforest.vim`
...
function! s:syn_write(rootpath, syn, content) "{{{
  " Write the content.
  ...
  " If there is something like `call s:highlight()`, then add
  " code to initialize the palette and configuration.
  if matchstr(a:content, 's:highlight') !=# ''
    call writefile([
          \ 'let s:configuration = s:get_configuration()',
          \ 'let s:palette = s:get_palette(s:configuration.background, s:configuration.colors_override)'
          \ ], syn_path, 'a')
  endif
  " Append the content.
...
function! s:syn_newest(path, last_modified) "{{{
...
function! s:syn_exists(path) "{{{
  return filereadable(s:syn_rootpath(a:path) . '/after/syntax/text/everforest.vim')
endfunction "}}}
function! s:ftplugin_detect(path) "{{{
  " Check if /after/ftplugin exists.
  " This directory is generated in earlier versions, users may need to manually clean it.
  let rootpath = s:syn_rootpath(a:path)
  if filereadable(s:syn_rootpath(a:path) . '/after/ftplugin/text/everforest.vim')
...
if s:configuration.transparent_background >= 1
  call s:highlight('Normal', s:palette.fg, s:palette.none)
  call s:highlight('NormalNC', s:palette.fg, s:palette.none)
  call s:highlight('Terminal', s:palette.fg, s:palette.none)
  if s:configuration.show_eob
    call s:highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call s:highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  if s:configuration.ui_contrast ==# 'low'
    call s:highlight('FoldColumn', s:palette.bg5, s:palette.none)
  else
    call s:highlight('FoldColumn', s:palette.grey0, s:palette.none)
  endif
  call s:highlight('Folded', s:palette.grey1, s:palette.none)
  call s:highlight('SignColumn', s:palette.fg, s:palette.none)
  call s:highlight('ToolbarLine', s:palette.fg, s:palette.none)
else
  call s:highlight('Normal', s:palette.fg, s:palette.bg0)
  if s:configuration.dim_inactive_windows
    call s:highlight('NormalNC', s:palette.fg, s:palette.bg_dim)
  else
    call s:highlight('NormalNC', s:palette.fg, s:palette.bg0)
  endif
  call s:highlight('Terminal', s:palette.fg, s:palette.bg0)
  if s:configuration.show_eob
    call s:highlight('EndOfBuffer', s:palette.bg4, s:palette.none)
  else
    call s:highlight('EndOfBuffer', s:palette.bg0, s:palette.none)
  endif
  call s:highlight('Folded', s:palette.grey1, s:palette.bg1)
  call s:highlight('ToolbarLine', s:palette.fg, s:palette.bg2)
  if s:configuration.sign_column_background ==# 'grey'
    call s:highlight('SignColumn', s:palette.fg, s:palette.bg1)
    call s:highlight('FoldColumn', s:palette.grey2, s:palette.bg1)
  else
    call s:highlight('SignColumn', s:palette.fg, s:palette.none)
    if s:configuration.ui_contrast ==# 'low'
      call s:highlight('FoldColumn', s:palette.bg5, s:palette.none)
...
call s:highlight('IncSearch', s:palette.bg0, s:palette.red)
call s:highlight('Search', s:palette.bg0, s:palette.green)
highlight! link CurSearch IncSearch
call s:highlight('ColorColumn', s:palette.none, s:palette.bg1)
if s:configuration.ui_contrast ==# 'low'
  call s:highlight('Conceal', s:palette.bg5, s:palette.none)
else
  call s:highlight('Conceal', s:palette.grey0, s:palette.none)
endif
if s:configuration.cursor ==# 'auto'
  call s:highlight('Cursor', s:palette.none, s:palette.none, 'reverse')
else
  call s:highlight('Cursor', s:palette.bg0, s:palette[s:configuration.cursor])
endif
...
if &diff
  call s:highlight('CursorLine', s:palette.none, s:palette.none, 'underline')
  call s:highlight('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
  call s:highlight('CursorLine', s:palette.none, s:palette.bg1)
  call s:highlight('CursorColumn', s:palette.none, s:palette.bg1)
endif
if s:configuration.ui_contrast ==# 'low'
  call s:highlight('LineNr', s:palette.bg5, s:palette.none)
  if &diff
    call s:highlight('CursorLineNr', s:palette.grey1, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call s:highlight('CursorLineNr', s:palette.grey1, s:palette.none)
  else
    call s:highlight('CursorLineNr', s:palette.grey1, s:palette.bg1)
  endif
else
  call s:highlight('LineNr', s:palette.grey0, s:palette.none)
  if &diff
    call s:highlight('CursorLineNr', s:palette.grey2, s:palette.none, 'underline')
  elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background ==# 'none'
    call s:highlight('CursorLineNr', s:palette.grey2, s:palette.none)
  else
    call s:highlight('CursorLineNr', s:palette.grey2, s:palette.bg1)
  endif
endif
call s:highlight('DiffAdd', s:palette.none, s:palette.bg_green)
call s:highlight('DiffChange', s:palette.none, s:palette.bg_blue)
call s:highlight('DiffDelete', s:palette.none, s:palette.bg_red)
call s:highlight('DiffText', s:palette.bg0, s:palette.blue)
call s:highlight('Directory', s:palette.green, s:palette.none)
call s:highlight('ErrorMsg', s:palette.red, s:palette.none, 'bold,underline')
call s:highlight('WarningMsg', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('ModeMsg', s:palette.fg, s:palette.none, 'bold')
call s:highlight('MoreMsg', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('MatchParen', s:palette.none, s:palette.bg4)
call s:highlight('NonText', s:palette.bg4, s:palette.none)
if has('nvim')
  call s:highlight('Whitespace', s:palette.bg4, s:palette.none)
  call s:highlight('SpecialKey', s:palette.yellow, s:palette.none)
else
  call s:highlight('SpecialKey', s:palette.bg3, s:palette.none)
endif
call s:highlight('Pmenu', s:palette.fg, s:palette.bg2)
call s:highlight('PmenuSbar', s:palette.none, s:palette.bg2)
call s:highlight('PmenuSel', s:palette.bg0, s:palette.statusline1)
call s:highlight('PmenuKind', s:palette.green, s:palette.bg2)
call s:highlight('PmenuExtra', s:palette.grey2, s:palette.bg2)
highlight! link WildMenu PmenuSel
call s:highlight('PmenuThumb', s:palette.none, s:palette.grey0)
if s:configuration.float_style ==# 'dim'
  call s:highlight('NormalFloat', s:palette.fg, s:palette.bg_dim)
  call s:highlight('FloatBorder', s:palette.grey1, s:palette.bg_dim)
  call s:highlight('FloatTitle', s:palette.fg, s:palette.bg_dim, 'bold')
else
  call s:highlight('NormalFloat', s:palette.fg, s:palette.bg2)
  call s:highlight('FloatBorder', s:palette.grey1, s:palette.bg2)
  call s:highlight('FloatTitle', s:palette.fg, s:palette.bg2, 'bold')
endif
call s:highlight('Question', s:palette.yellow, s:palette.none)
if s:configuration.spell_foreground ==# 'none'
  call s:highlight('SpellBad', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call s:highlight('SpellCap', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call s:highlight('SpellLocal', s:palette.none, s:palette.none, 'undercurl', s:palette.aqua)
  call s:highlight('SpellRare', s:palette.none, s:palette.none, 'undercurl', s:palette.purple)
else
  call s:highlight('SpellBad', s:palette.red, s:palette.none, 'undercurl', s:palette.red)
  call s:highlight('SpellCap', s:palette.blue, s:palette.none, 'undercurl', s:palette.blue)
  call s:highlight('SpellLocal', s:palette.aqua, s:palette.none, 'undercurl', s:palette.aqua)
  call s:highlight('SpellRare', s:palette.purple, s:palette.none, 'undercurl', s:palette.purple)
endif
if s:configuration.transparent_background == 2
  call s:highlight('StatusLine', s:palette.grey1, s:palette.none)
  call s:highlight('StatusLineTerm', s:palette.grey1, s:palette.none)
  call s:highlight('StatusLineNC', s:palette.grey0, s:palette.none)
  call s:highlight('StatusLineTermNC', s:palette.grey0, s:palette.none)
  call s:highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call s:highlight('TabLineFill', s:palette.grey1, s:palette.none)
  call s:highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call s:highlight('WinBar', s:palette.grey1, s:palette.none, 'bold')
    call s:highlight('WinBarNC', s:palette.grey0, s:palette.none)
  endif
else
  call s:highlight('StatusLine', s:palette.grey1, s:palette.bg2)
  call s:highlight('StatusLineTerm', s:palette.grey1, s:palette.bg1)
  call s:highlight('StatusLineNC', s:palette.grey1, s:palette.bg1)
  call s:highlight('StatusLineTermNC', s:palette.grey1, s:palette.bg0)
  call s:highlight('TabLine', s:palette.grey2, s:palette.bg3)
  call s:highlight('TabLineFill', s:palette.grey1, s:palette.bg1)
  call s:highlight('TabLineSel', s:palette.bg0, s:palette.statusline1)
  if has('nvim')
    call s:highlight('WinBar', s:palette.grey1, s:palette.bg2, 'bold')
    call s:highlight('WinBarNC', s:palette.grey1, s:palette.bg1)
  endif
endif
if s:configuration.dim_inactive_windows
  call s:highlight('VertSplit', s:palette.bg4, s:palette.bg_dim)
else
  call s:highlight('VertSplit', s:palette.bg4, s:palette.none)
endif
highlight! link WinSeparator VertSplit
call s:highlight('Visual', s:palette.none, s:palette.bg_visual)
call s:highlight('VisualNOS', s:palette.none, s:palette.bg_visual)
call s:highlight('QuickFixLine', s:palette.purple, s:palette.none, 'bold')
call s:highlight('Debug', s:palette.orange, s:palette.none)
call s:highlight('debugPC', s:palette.bg0, s:palette.green)
call s:highlight('debugBreakpoint', s:palette.bg0, s:palette.red)
call s:highlight('ToolbarButton', s:palette.bg0, s:palette.green)
if has('nvim')
  call s:highlight('Substitute', s:palette.bg0, s:palette.yellow)
  if s:configuration.diagnostic_text_highlight
    call s:highlight('DiagnosticError', s:palette.red, s:palette.bg_red)
    call s:highlight('DiagnosticUnderlineError', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
    call s:highlight('DiagnosticWarn', s:palette.yellow, s:palette.bg_yellow)
    call s:highlight('DiagnosticUnderlineWarn', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
    call s:highlight('DiagnosticInfo', s:palette.blue, s:palette.bg_blue)
    call s:highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
    call s:highlight('DiagnosticHint', s:palette.green, s:palette.bg_green)
    call s:highlight('DiagnosticUnderlineHint', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
  else
    call s:highlight('DiagnosticError', s:palette.red, s:palette.none)
    call s:highlight('DiagnosticUnderlineError', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
    call s:highlight('DiagnosticWarn', s:palette.yellow, s:palette.none)
    call s:highlight('DiagnosticUnderlineWarn', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
    call s:highlight('DiagnosticInfo', s:palette.blue, s:palette.none)
    call s:highlight('DiagnosticUnderlineInfo', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
    call s:highlight('DiagnosticHint', s:palette.green, s:palette.none)
    call s:highlight('DiagnosticUnderlineHint', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
  endif
...
" }}}
" Syntax: {{{
call s:highlight('Boolean', s:palette.purple, s:palette.none)
call s:highlight('Number', s:palette.purple, s:palette.none)
call s:highlight('Float', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call s:highlight('PreProc', s:palette.purple, s:palette.none, 'italic')
  call s:highlight('PreCondit', s:palette.purple, s:palette.none, 'italic')
  call s:highlight('Include', s:palette.purple, s:palette.none, 'italic')
  call s:highlight('Define', s:palette.purple, s:palette.none, 'italic')
  call s:highlight('Conditional', s:palette.red, s:palette.none, 'italic')
  call s:highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call s:highlight('Keyword', s:palette.red, s:palette.none, 'italic')
  call s:highlight('Typedef', s:palette.red, s:palette.none, 'italic')
  call s:highlight('Exception', s:palette.red, s:palette.none, 'italic')
  call s:highlight('Statement', s:palette.red, s:palette.none, 'italic')
else
  call s:highlight('PreProc', s:palette.purple, s:palette.none)
  call s:highlight('PreCondit', s:palette.purple, s:palette.none)
  call s:highlight('Include', s:palette.purple, s:palette.none)
  call s:highlight('Define', s:palette.purple, s:palette.none)
  call s:highlight('Conditional', s:palette.red, s:palette.none)
  call s:highlight('Repeat', s:palette.red, s:palette.none)
  call s:highlight('Keyword', s:palette.red, s:palette.none)
  call s:highlight('Typedef', s:palette.red, s:palette.none)
  call s:highlight('Exception', s:palette.red, s:palette.none)
  call s:highlight('Statement', s:palette.red, s:palette.none)
endif
call s:highlight('Error', s:palette.red, s:palette.none)
call s:highlight('StorageClass', s:palette.orange, s:palette.none)
call s:highlight('Tag', s:palette.orange, s:palette.none)
call s:highlight('Label', s:palette.orange, s:palette.none)
call s:highlight('Structure', s:palette.orange, s:palette.none)
call s:highlight('Operator', s:palette.orange, s:palette.none)
call s:highlight('Title', s:palette.orange, s:palette.none, 'bold')
call s:highlight('Special', s:palette.yellow, s:palette.none)
call s:highlight('SpecialChar', s:palette.yellow, s:palette.none)
call s:highlight('Type', s:palette.yellow, s:palette.none)
call s:highlight('Function', s:palette.green, s:palette.none)
call s:highlight('String', s:palette.green, s:palette.none)
call s:highlight('Character', s:palette.green, s:palette.none)
call s:highlight('Constant', s:palette.aqua, s:palette.none)
call s:highlight('Macro', s:palette.aqua, s:palette.none)
call s:highlight('Identifier', s:palette.blue, s:palette.none)
call s:highlight('Todo', s:palette.bg0, s:palette.blue, 'bold')
if s:configuration.disable_italic_comment
  call s:highlight('Comment', s:palette.grey1, s:palette.none)
  call s:highlight('SpecialComment', s:palette.grey1, s:palette.none)
else
  call s:highlight('Comment', s:palette.grey1, s:palette.none, 'italic')
  call s:highlight('SpecialComment', s:palette.grey1, s:palette.none, 'italic')
endif
call s:highlight('Delimiter', s:palette.fg, s:palette.none)
...
call s:highlight('Aqua', s:palette.aqua, s:palette.none)
call s:highlight('Blue', s:palette.blue, s:palette.none)
call s:highlight('Purple', s:palette.purple, s:palette.none)
if s:configuration.enable_italic
  call s:highlight('RedItalic', s:palette.red, s:palette.none, 'italic')
  call s:highlight('OrangeItalic', s:palette.orange, s:palette.none, 'italic')
  call s:highlight('YellowItalic', s:palette.yellow, s:palette.none, 'italic')
  call s:highlight('GreenItalic', s:palette.green, s:palette.none, 'italic')
  call s:highlight('AquaItalic', s:palette.aqua, s:palette.none, 'italic')
  call s:highlight('BlueItalic', s:palette.blue, s:palette.none, 'italic')
  call s:highlight('PurpleItalic', s:palette.purple, s:palette.none, 'italic')
else
  call s:highlight('RedItalic', s:palette.red, s:palette.none)
  call s:highlight('OrangeItalic', s:palette.orange, s:palette.none)
  call s:highlight('YellowItalic', s:palette.yellow, s:palette.none)
  call s:highlight('GreenItalic', s:palette.green, s:palette.none)
  call s:highlight('AquaItalic', s:palette.aqua, s:palette.none)
  call s:highlight('BlueItalic', s:palette.blue, s:palette.none)
  call s:highlight('PurpleItalic', s:palette.purple, s:palette.none)
endif
if s:configuration.transparent_background || s:configuration.sign_column_background ==# 'none'
  call s:highlight('RedSign', s:palette.red, s:palette.none)
  call s:highlight('OrangeSign', s:palette.orange, s:palette.none)
  call s:highlight('YellowSign', s:palette.yellow, s:palette.none)
  call s:highlight('GreenSign', s:palette.green, s:palette.none)
  call s:highlight('AquaSign', s:palette.aqua, s:palette.none)
  call s:highlight('BlueSign', s:palette.blue, s:palette.none)
  call s:highlight('PurpleSign', s:palette.purple, s:palette.none)
else
  call s:highlight('RedSign', s:palette.red, s:palette.bg1)
  call s:highlight('OrangeSign', s:palette.orange, s:palette.bg1)
  call s:highlight('YellowSign', s:palette.yellow, s:palette.bg1)
  call s:highlight('GreenSign', s:palette.green, s:palette.bg1)
  call s:highlight('AquaSign', s:palette.aqua, s:palette.bg1)
  call s:highlight('BlueSign', s:palette.blue, s:palette.bg1)
  call s:highlight('PurpleSign', s:palette.purple, s:palette.bg1)
endif
if s:configuration.diagnostic_text_highlight
  call s:highlight('ErrorText', s:palette.none, s:palette.bg_red, 'undercurl', s:palette.red)
  call s:highlight('WarningText', s:palette.none, s:palette.bg_yellow, 'undercurl', s:palette.yellow)
  call s:highlight('InfoText', s:palette.none, s:palette.bg_blue, 'undercurl', s:palette.blue)
  call s:highlight('HintText', s:palette.none, s:palette.bg_green, 'undercurl', s:palette.green)
else
  call s:highlight('ErrorText', s:palette.none, s:palette.none, 'undercurl', s:palette.red)
  call s:highlight('WarningText', s:palette.none, s:palette.none, 'undercurl', s:palette.yellow)
  call s:highlight('InfoText', s:palette.none, s:palette.none, 'undercurl', s:palette.blue)
  call s:highlight('HintText', s:palette.none, s:palette.none, 'undercurl', s:palette.green)
endif
if s:configuration.diagnostic_line_highlight
  call s:highlight('ErrorLine', s:palette.none, s:palette.bg_red)
  call s:highlight('WarningLine', s:palette.none, s:palette.bg_yellow)
  call s:highlight('InfoLine', s:palette.none, s:palette.bg_blue)
  call s:highlight('HintLine', s:palette.none, s:palette.bg_green)
else
...
elseif s:configuration.diagnostic_virtual_text ==# 'colored'
  ...
  call s:highlight('VirtualTextWarning', s:palette.yellow, s:palette.bg_yellow)
  call s:highlight('VirtualTextError', s:palette.red, s:palette.bg_red)
  call s:highlight('VirtualTextInfo', s:palette.blue, s:palette.bg_blue)
  call s:highlight('VirtualTextHint', s:palette.green, s:palette.bg_green)
endif
call s:highlight('ErrorFloat', s:palette.red, s:palette.none)
call s:highlight('WarningFloat', s:palette.yellow, s:palette.none)
call s:highlight('InfoFloat', s:palette.blue, s:palette.none)
call s:highlight('HintFloat', s:palette.green, s:palette.none)
if &diff
  call s:highlight('CurrentWord', s:palette.bg0, s:palette.green)
elseif s:configuration.current_word ==# 'grey background'
  call s:highlight('CurrentWord', s:palette.none, s:palette.bg2)
else
  call s:highlight('CurrentWord', s:palette.none, s:palette.none, s:configuration.current_word)
endif
if s:configuration.inlay_hints_background ==# 'none'
  highlight! link InlayHints LineNr
else
  call s:highlight('InlayHints', s:palette.grey1, s:palette.bg_dim)
endif
...
call s:highlight('TSStrong', s:palette.none, s:palette.none, 'bold')
call s:highlight('TSEmphasis', s:palette.none, s:palette.none, 'italic')
call s:highlight('TSUnderline', s:palette.none, s:palette.none, 'underline')
call s:highlight('TSNote', s:palette.bg0, s:palette.green, 'bold')
call s:highlight('TSWarning', s:palette.bg0, s:palette.yellow, 'bold')
call s:highlight('TSDanger', s:palette.bg0, s:palette.red, 'bold')
...
call s:highlight('TSURI', s:palette.blue, s:palette.none, 'underline')
...
if has('nvim-0.9')
  ...
  call s:highlight('DiagnosticUnnecessary', s:palette.grey1, s:palette.none)
endif
...
" }}}
" neoclide/coc.nvim {{{
call s:highlight('CocHoverRange', s:palette.none, s:palette.none, 'bold,underline')
call s:highlight('CocSearch', s:palette.green, s:palette.none, 'bold')
call s:highlight('CocPumSearch', s:palette.green, s:palette.none, 'bold')
call s:highlight('CocMarkdownHeader', s:palette.orange, s:palette.none, 'bold')
call s:highlight('CocMarkdownLink', s:palette.green, s:palette.none, 'underline')
...
call s:highlight('Lf_hl_match', s:palette.green, s:palette.none, 'bold')
call s:highlight('Lf_hl_match0', s:palette.green, s:palette.none, 'bold')
call s:highlight('Lf_hl_match1', s:palette.aqua, s:palette.none, 'bold')
call s:highlight('Lf_hl_match2', s:palette.blue, s:palette.none, 'bold')
call s:highlight('Lf_hl_match3', s:palette.purple, s:palette.none, 'bold')
call s:highlight('Lf_hl_match4', s:palette.orange, s:palette.none, 'bold')
call s:highlight('Lf_hl_matchRefine', s:palette.red, s:palette.none, 'bold')
call s:highlight('Lf_hl_popup_normalMode', s:palette.bg0, s:palette.red, 'bold')
call s:highlight('Lf_hl_popup_inputMode', s:palette.bg0, s:palette.green, 'bold')
call s:highlight('Lf_hl_popup_category', s:palette.fg, s:palette.bg4)
call s:highlight('Lf_hl_popup_nameOnlyMode', s:palette.fg, s:palette.bg3)
call s:highlight('Lf_hl_popup_fullPathMode', s:palette.fg, s:palette.bg3)
call s:highlight('Lf_hl_popup_fuzzyMode', s:palette.fg, s:palette.bg3)
call s:highlight('Lf_hl_popup_regexMode', s:palette.fg, s:palette.bg3)
call s:highlight('Lf_hl_popup_lineInfo', s:palette.yellow, s:palette.bg4)
call s:highlight('Lf_hl_popup_total', s:palette.bg0, s:palette.orange)
call s:highlight('Lf_hl_popup_cursor', s:palette.bg0, s:palette.green)
...
" }}}
" liuchengxu/vim-clap {{{
call s:highlight('ClapSelected', s:palette.red, s:palette.none, 'bold')
call s:highlight('ClapCurrentSelection', s:palette.none, s:palette.bg1, 'bold')
call s:highlight('ClapSpinner', s:palette.orange, s:palette.bg2, 'bold')
call s:highlight('ClapBlines', s:palette.fg, s:palette.none)
call s:highlight('ClapProviderId', s:palette.fg, s:palette.none, 'bold')
call s:highlight('ClapMatches1', s:palette.red, s:palette.none, 'bold')
call s:highlight('ClapMatches2', s:palette.orange, s:palette.none, 'bold')
call s:highlight('ClapMatches3', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('ClapMatches4', s:palette.aqua, s:palette.none, 'bold')
call s:highlight('ClapMatches5', s:palette.blue, s:palette.none, 'bold')
call s:highlight('ClapMatches6', s:palette.purple, s:palette.none, 'bold')
call s:highlight('ClapFuzzyMatches', s:palette.green, s:palette.none, 'bold')
call s:highlight('ClapNoMatchesFound', s:palette.red, s:palette.none, 'bold')
...
" }}}
" Shougo/denite.nvim {{{
call s:highlight('deniteMatchedChar', s:palette.green, s:palette.none, 'bold')
call s:highlight('deniteMatchedRange', s:palette.green, s:palette.none, 'bold,underline')
call s:highlight('deniteInput', s:palette.green, s:palette.bg3, 'bold')
call s:highlight('deniteStatusLineNumber', s:palette.purple, s:palette.bg3)
call s:highlight('deniteStatusLinePath', s:palette.fg, s:palette.bg3)
...
call s:highlight('CtrlPStats', s:palette.grey1, s:palette.bg3, 'bold')
...
call s:highlight('MatchParenCur', s:palette.none, s:palette.none, 'bold')
call s:highlight('MatchWord', s:palette.none, s:palette.none, 'underline')
call s:highlight('MatchWordCur', s:palette.none, s:palette.none, 'underline')
" }}}
...
" }}}
" justinmk/vim-sneak {{{
call s:highlight('SneakLabelMask', s:palette.orange, s:palette.orange)
...
call s:highlight('VMCursor', s:palette.blue, s:palette.bg_blue)
...
if get(g:, 'indent_guides_auto_colors', 1) == 0
  call s:highlight('IndentGuidesOdd', s:palette.bg0, s:palette.bg1)
  call s:highlight('IndentGuidesEven', s:palette.bg0, s:palette.bg2)
endif
" }}}
...
call s:highlight('QuickScopePrimary', s:palette.aqua, s:palette.none, 'underline')
call s:highlight('QuickScopeSecondary', s:palette.blue, s:palette.none, 'underline')
" }}}
" APZelos/blamer.nvim {{{
...
if has('nvim')
" hrsh7th/nvim-cmp {{{
call s:highlight('CmpItemAbbrMatch', s:palette.green, s:palette.none, 'bold')
call s:highlight('CmpItemAbbrMatchFuzzy', s:palette.green, s:palette.none, 'bold')
...
call s:highlight('TelescopeMatching', s:palette.green, s:palette.none, 'bold')
...
" }}}
" phaazon/hop.nvim {{{
call s:highlight('HopNextKey', s:palette.orange, s:palette.none, 'bold')
call s:highlight('HopNextKey1', s:palette.green, s:palette.none, 'bold')
highlight! link HopNextKey2 Green
highlight! link HopUnmatched Grey
" }}}
" lukas-reineke/indent-blankline.nvim {{{
call s:highlight('IblScope', s:palette.grey1, s:palette.none, 'nocombine')
call s:highlight('IblIndent', s:palette.bg4, s:palette.none, 'nocombine')
call s:highlight('IndentBlanklineContextStart', s:palette.none, s:palette.bg2)
...
" }}}
" romgrk/barbar.nvim {{{
call s:highlight('BufferCurrent', s:palette.fg, s:palette.bg0)
call s:highlight('BufferCurrentIndex', s:palette.fg, s:palette.bg0)
call s:highlight('BufferCurrentMod', s:palette.blue, s:palette.bg0)
call s:highlight('BufferCurrentSign', s:palette.statusline1, s:palette.bg0)
call s:highlight('BufferCurrentTarget', s:palette.red, s:palette.bg0, 'bold')
call s:highlight('BufferVisible', s:palette.fg, s:palette.bg_dim)
call s:highlight('BufferVisibleIndex', s:palette.fg, s:palette.bg_dim)
call s:highlight('BufferVisibleMod', s:palette.blue, s:palette.bg_dim)
call s:highlight('BufferVisibleSign', s:palette.statusline1, s:palette.bg_dim)
call s:highlight('BufferVisibleTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call s:highlight('BufferInactive', s:palette.grey1, s:palette.bg_dim)
call s:highlight('BufferInactiveIndex', s:palette.grey1, s:palette.bg_dim)
call s:highlight('BufferInactiveMod', s:palette.grey1, s:palette.bg_dim)
call s:highlight('BufferInactiveSign', s:palette.grey0, s:palette.bg_dim)
call s:highlight('BufferInactiveTarget', s:palette.yellow, s:palette.bg_dim, 'bold')
call s:highlight('BufferTabpages', s:palette.grey1, s:palette.bg_dim, 'bold')
call s:highlight('BufferTabpageFill', s:palette.bg_dim, s:palette.bg_dim)
" }}}
" rcarriga/nvim-notify {{{
call s:highlight('NotifyBackground', s:palette.none, s:palette.bg0)
...
call s:highlight('DapUIModifiedValue', s:palette.blue, s:palette.none, 'bold')
call s:highlight('DapUIBreakpointsCurrentLine', s:palette.blue, s:palette.none, 'bold')
...
call s:highlight('LspFloatWinBorder', s:palette.bg0, s:palette.bg0)
call s:highlight('LspSagaDiagnosticHeader', s:palette.orange, s:palette.none, 'bold')
call s:highlight('LspSagaCodeActionTitle', s:palette.purple, s:palette.none, 'bold')
call s:highlight('DefinitionPreviewTitle', s:palette.blue, s:palette.none, 'bold')
...
" }}}
" b0o/incline.nvim {{{
call s:highlight('InclineNormalNC', s:palette.grey1, s:palette.bg2)
" }}}
" echasnovski/mini.nvim {{{
call s:highlight('MiniAnimateCursor', s:palette.none, s:palette.none, 'reverse,nocombine')
call s:highlight('MiniFilesFile', s:palette.fg, s:palette.none)
if s:configuration.float_style ==# 'dim'
  call s:highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg_dim, 'bold')
else
  call s:highlight('MiniFilesTitleFocused', s:palette.green, s:palette.bg2, 'bold')
endif
call s:highlight('MiniHipatternsFixme', s:palette.bg0, s:palette.red, 'bold')
call s:highlight('MiniHipatternsHack', s:palette.bg0, s:palette.yellow, 'bold')
call s:highlight('MiniHipatternsNote', s:palette.bg0, s:palette.blue, 'bold')
call s:highlight('MiniHipatternsTodo', s:palette.bg0, s:palette.green, 'bold')
call s:highlight('MiniIconsAzure', s:palette.blue, s:palette.none)
call s:highlight('MiniIconsBlue', s:palette.blue, s:palette.none)
call s:highlight('MiniIconsCyan', s:palette.aqua, s:palette.none)
call s:highlight('MiniIconsGreen', s:palette.green, s:palette.none)
call s:highlight('MiniIconsGrey', s:palette.grey2, s:palette.none)
call s:highlight('MiniIconsOrange', s:palette.orange, s:palette.none)
call s:highlight('MiniIconsPurple', s:palette.purple, s:palette.none)
call s:highlight('MiniIconsRed', s:palette.red, s:palette.none)
call s:highlight('MiniIconsYellow', s:palette.yellow, s:palette.none)
call s:highlight('MiniIndentscopePrefix', s:palette.none, s:palette.none, 'nocombine')
call s:highlight('MiniJump2dSpot', s:palette.orange, s:palette.none, 'bold,nocombine')
call s:highlight('MiniJump2dSpotAhead', s:palette.aqua, s:palette.none, 'nocombine')
call s:highlight('MiniJump2dSpotUnique', s:palette.yellow, s:palette.none, 'bold,nocombine')
if s:configuration.float_style ==# 'dim'
  call s:highlight('MiniPickPrompt', s:palette.blue, s:palette.bg_dim)
else
  call s:highlight('MiniPickPrompt', s:palette.blue, s:palette.bg2)
endif
call s:highlight('MiniStarterCurrent', s:palette.none, s:palette.none, 'nocombine')
call s:highlight('MiniStatuslineDevinfo', s:palette.grey1, s:palette.bg1)
call s:highlight('MiniStatuslineFileinfo', s:palette.grey1, s:palette.bg1)
call s:highlight('MiniStatuslineModeCommand', s:palette.bg0, s:palette.aqua, 'bold')
call s:highlight('MiniStatuslineModeInsert', s:palette.bg0, s:palette.statusline2, 'bold')
call s:highlight('MiniStatuslineModeNormal', s:palette.bg0, s:palette.statusline1, 'bold')
call s:highlight('MiniStatuslineModeOther', s:palette.bg0, s:palette.purple, 'bold')
call s:highlight('MiniStatuslineModeReplace', s:palette.bg0, s:palette.orange, 'bold')
call s:highlight('MiniStatuslineModeVisual', s:palette.bg0, s:palette.statusline3, 'bold')
call s:highlight('MiniTablineCurrent', s:palette.fg, s:palette.bg4)
call s:highlight('MiniTablineHidden', s:palette.grey1, s:palette.bg2)
call s:highlight('MiniTablineModifiedCurrent', s:palette.blue, s:palette.bg4)
call s:highlight('MiniTablineModifiedHidden', s:palette.grey1, s:palette.bg2)
call s:highlight('MiniTablineModifiedVisible', s:palette.blue, s:palette.bg2)
call s:highlight('MiniTablineTabpagesection', s:palette.bg0, s:palette.statusline1, 'bold')
call s:highlight('MiniTablineVisible', s:palette.fg, s:palette.bg2)
call s:highlight('MiniTestEmphasis', s:palette.none, s:palette.none, 'bold')
call s:highlight('MiniTestFail', s:palette.red, s:palette.none, 'bold')
call s:highlight('MiniTestPass', s:palette.green, s:palette.none, 'bold')
call s:highlight('MiniTrailspace', s:palette.none, s:palette.red)
...
call s:highlight('LightspeedLabel', s:palette.red, s:palette.none, 'bold,underline')
call s:highlight('LightspeedLabelDistant', s:palette.blue, s:palette.none, 'bold,underline')
call s:highlight('LightspeedShortcut', s:palette.bg0, s:palette.red, 'bold')
call s:highlight('LightspeedUnlabeledMatch', s:palette.fg, s:palette.none, 'bold')
call s:highlight('LightspeedPendingOpArea', s:palette.bg0, s:palette.green)
...
if s:syn_exists(s:path) " If the syntax files exist.
  if s:configuration.better_performance
    if !s:syn_newest(s:path, s:last_modified) " Regenerate if it's not up to date.
      call s:syn_clean(s:path, 0)
      call s:syn_gen(s:path, s:last_modified, 'update')
    endif
    finish
  else
    call s:syn_clean(s:path, 1)
  endif
else
  if s:configuration.better_performance
    call s:syn_gen(s:path, s:last_modified, 'generate')
    finish
  endif
endif
" syn_begin: vim-plug {{{
" https://github.com/junegunn/vim-plug
call s:highlight('plug1', s:palette.orange, s:palette.none, 'bold')
call s:highlight('plugNumber', s:palette.yellow, s:palette.none, 'bold')
...
if !s:configuration.transparent_background
  call s:highlight('NvimTreeNormal', s:palette.fg, s:palette.bg_dim)
  call s:highlight('NvimTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call s:highlight('NvimTreeVertSplit', s:palette.bg0, s:palette.bg0)
  call s:highlight('NvimTreeCursorLine', s:palette.none, s:palette.bg0)
endif
...
if !s:configuration.transparent_background
  call s:highlight('NeoTreeNormal', s:palette.fg, s:palette.bg_dim)
  call s:highlight('NeoTreeEndOfBuffer', s:palette.bg_dim, s:palette.bg_dim)
  call s:highlight('NeoTreeVertSplit', s:palette.bg0, s:palette.bg0)
endif
...
call s:highlight('OctoViewer', s:palette.bg0, s:palette.blue)
call s:highlight('OctoGreenFloat', s:palette.green, s:palette.bg2)
call s:highlight('OctoRedFloat', s:palette.red, s:palette.bg2)
call s:highlight('OctoPurpleFloat', s:palette.purple, s:palette.bg2)
call s:highlight('OctoYellowFloat', s:palette.yellow, s:palette.bg2)
call s:highlight('OctoBlueFloat', s:palette.blue, s:palette.bg2)
call s:highlight('OctoGreyFloat', s:palette.grey1, s:palette.bg2)
call s:highlight('OctoBubbleGreen', s:palette.bg0, s:palette.green)
call s:highlight('OctoBubbleRed', s:palette.bg0, s:palette.red)
call s:highlight('OctoBubblePurple', s:palette.bg0, s:palette.purple)
call s:highlight('OctoBubbleYellow', s:palette.bg0, s:palette.yellow)
call s:highlight('OctoBubbleBlue', s:palette.bg0, s:palette.blue)
call s:highlight('OctoBubbleGrey', s:palette.bg0, s:palette.grey1)
...
call s:highlight('UndotreeSavedBig', s:palette.purple, s:palette.none, 'bold')
...
" syn_begin: markdown {{{
" builtin: {{{
call s:highlight('markdownH1', s:palette.red, s:palette.none, 'bold')
call s:highlight('markdownH2', s:palette.orange, s:palette.none, 'bold')
call s:highlight('markdownH3', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('markdownH4', s:palette.green, s:palette.none, 'bold')
call s:highlight('markdownH5', s:palette.blue, s:palette.none, 'bold')
call s:highlight('markdownH6', s:palette.purple, s:palette.none, 'bold')
...
call s:highlight('mkdURL', s:palette.blue, s:palette.none, 'underline')
call s:highlight('mkdInlineURL', s:palette.purple, s:palette.none, 'underline')
...
if has('nvim-0.8')
  ...
  if !has('nvim-0.10')
    call s:highlight('@markup.italic', s:palette.none, s:palette.none, 'italic')
    call s:highlight('@markup.strikethrough', s:palette.none, s:palette.none, 'strikethrough')
  endif
endif
" }}}
" syn_end }}}
" syn_begin: vimwiki {{{
call s:highlight('VimwikiHeader1', s:palette.red, s:palette.none, 'bold')
call s:highlight('VimwikiHeader2', s:palette.orange, s:palette.none, 'bold')
call s:highlight('VimwikiHeader3', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('VimwikiHeader4', s:palette.green, s:palette.none, 'bold')
call s:highlight('VimwikiHeader5', s:palette.blue, s:palette.none, 'bold')
call s:highlight('VimwikiHeader6', s:palette.purple, s:palette.none, 'bold')
call s:highlight('VimwikiLink', s:palette.blue, s:palette.none, 'underline')
call s:highlight('VimwikiItalic', s:palette.none, s:palette.none, 'italic')
call s:highlight('VimwikiBold', s:palette.none, s:palette.none, 'bold')
call s:highlight('VimwikiUnderline', s:palette.none, s:palette.none, 'underline')
...
call s:highlight('rstStandaloneHyperlink', s:palette.purple, s:palette.none, 'underline')
...
call s:highlight('htmlH1', s:palette.red, s:palette.none, 'bold')
call s:highlight('htmlH2', s:palette.orange, s:palette.none, 'bold')
call s:highlight('htmlH3', s:palette.yellow, s:palette.none, 'bold')
call s:highlight('htmlH4', s:palette.green, s:palette.none, 'bold')
call s:highlight('htmlH5', s:palette.blue, s:palette.none, 'bold')
call s:highlight('htmlH6', s:palette.purple, s:palette.none, 'bold')
...
call s:highlight('semshiUnresolved', s:palette.yellow, s:palette.none, 'undercurl')
...
" syn_end }}}
" syn_begin: vim {{{
call s:highlight('vimCommentTitle', s:palette.grey1, s:palette.none, 'bold')
...
call s:highlight('tomlTable', s:palette.orange, s:palette.none, 'bold')
...
" syn_end }}}
" syn_begin: dosini {{{
call s:highlight('dosiniHeader', s:palette.red, s:palette.none, 'bold')
highlight! link dosiniLabel Yellow
highlight! link dosiniValue Green
highlight! link dosiniNumber Green
" syn_end }}}
" syn_begin: help {{{
call s:highlight('helpNote', s:palette.purple, s:palette.none, 'bold')
call s:highlight('helpHeadline', s:palette.red, s:palette.none, 'bold')
call s:highlight('helpHeader', s:palette.orange, s:palette.none, 'bold')
call s:highlight('helpURL', s:palette.green, s:palette.none, 'underline')
call s:highlight('helpHyperTextEntry', s:palette.yellow, s:palette.none, 'bold')
...
call s:highlight('NeotestExpandMarker', s:palette.bg5, s:palette.none)
...
call s:highlight('MasonHeader', s:palette.bg0, s:palette.green, 'bold')
call s:highlight('MasonHeaderSecondary', s:palette.bg0, s:palette.orange, 'bold')
highlight! link MasonHighlight Green
highlight! link MasonHighlightSecondary Yellow
call s:highlight('MasonHighlightBlock', s:palette.bg0, s:palette.aqua)
call s:highlight('MasonHighlightBlockBold', s:palette.bg0, s:palette.aqua, 'bold')
call s:highlight('MasonHighlightBlockSecondary', s:palette.bg0, s:palette.yellow)
call s:highlight('MasonHighlightBlockBoldSecondary', s:palette.bg0, s:palette.yellow, 'bold')
call s:highlight('MasonMuted', s:palette.grey0, s:palette.none)
call s:highlight('MasonMutedBlock', s:palette.bg0, s:palette.grey0)
" syn_end }}}
" }}}
